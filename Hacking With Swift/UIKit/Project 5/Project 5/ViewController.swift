...
@objc func promptForAnswer(){
    let ac = UIAlertController(title: "enter a new word", message: nil, preferredStyle: .alert)
    ac.addTextField()
    
    let submitAction = UIAlertAction(title: "Sumbit", style: .default) { [weak self, weak ac]
        _ in
